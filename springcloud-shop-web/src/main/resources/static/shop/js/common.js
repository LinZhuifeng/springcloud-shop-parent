...
(function ($) {
    ...
    $.redirectLogin = function (redirectUrl) {
        var loginUrl = "/shopxxb2b2c/member/login";
        if ($.trim(redirectUrl) != "") {
    ...
    $.dialog = function (options) {
        ...
        if ($dialogTitle != null) {
            ...
            $(document).mousemove(function (event) {
                if (dragging) {
                    $dialog.offset({
                        "left": dragStart.left + event.pageX - dragStart.pageX,
                        "top": dragStart.top + event.pageY - dragStart.pageY
                    });
                    return false;
                }
            }).mouseup(function () {
